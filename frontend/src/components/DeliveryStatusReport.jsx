    ...
    <div className="delivery-report-enhanced">
      ...
      <div className="delivery-report-header-enhanced">
        <div className="header-content-enhanced">
          <h1 className="report-title-enhanced">Delivery Status Report</h1>
          <p className="report-subtitle-enhanced">Track and monitor all delivery operations</p>
        </div>
              ...
              {filteredDeliveries.length > 0 ? (
                filteredDeliveries.map((delivery, index) => (
                  <tr key={delivery._id} className="delivery-row-enhanced" style={{animationDelay: `${index * 0.1}s`}}>
                    ...
                    <td className="delivery-cell-enhanced">
                      <div 
                        className="delivery-id-enhanced"
                        onClick={() => copyToClipboard(delivery.deliveryId)}
                      >
                        <span className="id-number-enhanced">{delivery.deliveryId}</span>
                        <span className="copy-icon-enhanced">
                          {copiedId === delivery.deliveryId ? "✅ Copied!" : <GoCopy />}
                        </span>
                      </div>
                    </td>
                    <td className="delivery-cell-enhanced">
                    ...
                    <td className="delivery-cell-enhanced">
                      <div className="destination-details-enhanced">
                        ...
                        <button
                          className={`copy-destination-btn-enhanced ${copiedId === buildDestination(delivery) ? 'copied' : ''}`}
                          onClick={() => copyToClipboard(buildDestination(delivery))}
                          title="Copy Destination"
                          data-copied={copiedId === buildDestination(delivery)}
                        >
                          {copiedId === buildDestination(delivery) ? "✅ Copied!" : "📋 Copy"}
                        </button>
                      </div>
                    </td>
                    <td className="delivery-cell-enhanced">
